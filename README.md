[![Package Status](https://github.com/bcgov/devhub-transfer-test/actions/workflows/publish.yaml/badge.svg)](https://github.com/bcgov/devhub-transfer-test/actions/workflows/publish.yaml)
